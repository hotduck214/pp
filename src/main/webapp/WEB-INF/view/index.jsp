			...
			<div class="allmenu">전체메뉴
				...
				<!-- 	<dl style="width:13.666%;">
					...
					<dl style="width:15.666%;">
						...
						<dd><a href="javascript:;" onclick="clickMenu('portfolio5', '자유게시판(댓글)', '/portfolio/free/index.do', false)">댓글게시판</a></dd>
						<dd><a href="javascript:;" onclick="clickMenu('portfolio3', 'Q&A문의(답변)', '/portfolio/reply/index.do', false)">Q&A</a></dd>
						<dd><a href="javascript:;" onclick="clickMenu('portfolio2', '갤러리', '/portfolio/gallery/index.do', false)">갤러리</a></dd>
						<dd><a href="javascript:;" onclick="clickMenu('portfolio6', '회원가입/로그인', '/portfolio/user/login.do', false)">회원가입/로그인</a></dd>
					</dl>
				</div>
			</div>
			<div class="gnb">
				<dl>
					...
					<dd class="gnb_submenu">
						<ul>	
							...
							<li id="portfolio5_submenu" onclick="clickMenu('portfolio5', '자유게시판(댓글)', '/portfolio/free/index.do', false)">자유게시판(댓글)</li>
							<li id="portfolio3_submenu" onclick="clickMenu('portfolio3', 'Q&A문의(답변)', '/portfolio/reply/index.do', false)">Q&A문의(답변)</li>
							<li id="portfolio2_submenu" onclick="clickMenu('portfolio2', '갤러리', '/portfolio/gallery/index.do', false)">갤러리</li>
							<li id="portfolio6_submenu" onclick="clickMenu('portfolio6', '회원가입/로그인', '/portfolio/user/login.do', false)">회원가입/로그인</li>
						</ul>
					</dd>
				</dl>
			</div>
