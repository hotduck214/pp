                ...
                <table class="board_write">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th rowspan="3">주소</th>
                            <td>
                                <input type="text" name="user_zipcode" id="user_zipcode" class="inNextBtn" style="float:left;" readonly>
                                <span class="email_check"><a href="javascript:zipcode();"  class="btn bgGray" style="float:left; width:auto; clear:none;">우편번호</a></span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            	<input type="text" name="user_addr1" id="user_addr1" style="width:80%" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            	<input type="text" name="user_addr2" id="user_addr2" style="width:80%">
                            </td>
                        </tr>
                    </tbody>
                </table>
